...
public class ShowChildCodeAdapter extends RecyclerView.Adapter<ShowChildCodeAdapter.ViewHolder> {
    ...
    public ShowChildCodeAdapter(Context context, List<ProjectActivityType> listProject, boolean fromParent) {
